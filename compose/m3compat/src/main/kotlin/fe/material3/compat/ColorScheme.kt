...
import fe.material3.compat.tokens.ColorSchemeKeyTokens
import androidx.compose.material3.ColorScheme as M3ColorScheme

@Stable
internal fun M3ColorScheme.fromToken(value: ColorSchemeKeyTokens): Color {
    return when (value) {
...
public val ColorSchemeKeyTokens.value: Color
